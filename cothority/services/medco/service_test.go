...
import (
	...
	"bls-ftcosi/cothority/services/medco"
	. "bls-ftcosi/cothority/services/medco/libmedco"
)
...
func TestService(t *testing.T) {
	t.Skip("Issue with deadlock occuring in the medco protocol: https://bls-ftcosi/cothority/issues/479")
